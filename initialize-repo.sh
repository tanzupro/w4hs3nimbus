...
echo
echo Continue to create GitHub TAP GitOps Repo w4hs3nimbus
echo     https://github.com/tanzupro/w4hs3nimbus
echo
...
git add .
git commit -am "."
gh repo create w4hs3nimbus --private
git remote add origin https://github.com/tanzupro/w4hs3nimbus
git branch -M main
